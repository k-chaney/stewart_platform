...
int main(int argc, char *argv[])
{
	...
	ros::NodeHandle n;
	ros::Publisher chatter_pub = n.advertise<std_msgs::Float64MultiArray>("/tracker/centers", 1000);
	std_msgs::Float64MultiArray centers;
	ros::Publisher chatter_pub = n.advertise<std_msgs::Float64MultiArray>("/tracker/radii", 1000);
